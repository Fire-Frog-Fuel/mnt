...
def hash_string(input_string):
    ...
    hash_object = hashlib.sha256()  # You can also use hashlib.sha1(), hashlib.md5(), etc.
...
def auth(username,password):
    ...
    if not lost_connection:
        try:
            ...
            messages_to_send = [username,password] #Add here everything you want to send in main body of packet
